...
function SectionTitle({
  ...
  return (
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 flex flex-col items-start">
      ...
      <h2
        ref={titleRef}
        className={`${orbitron.className} relative z-10 text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight mb-0 text-left text-pure-white drop-shadow-lg`}
        style={{
          transition: "font-size 0.2s",
        }}
      >
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-1 p-8">
        <h3
          className={`${orbitron.className} text-2xl md:text-3xl font-bold text-pure-white mb-2 group-hover:text-p2-mint-flash transition`}
        >
          {game.title}
        </h3>
