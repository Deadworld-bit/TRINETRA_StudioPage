...
const HERO_TITLE = `Let’s have a talk together`;
...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className={`absolute bottom-6 left-[10%] flex items-center space-x-2 text-lg text-pure-white ${manrope.className}`}>  
