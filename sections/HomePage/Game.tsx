              ...
              >
                ...
                {idx === 0 && (
                  <div className="absolute inset-0 flex flex-col justify-end p-8 text-white">
                    ...
                    <p className="text-lg text-p3-white-smoke leading-relaxed line-clamp-3 max-w-2xl mb-8"> 
                ...
                {idx !== 0 && (
                  <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center text-white">
                    ...
                    <h3 className={`${orbitron.className} text-3xl sm:text-4xl font-bold tracking-wide`}> 
                      {game.title}
                    </h3>
