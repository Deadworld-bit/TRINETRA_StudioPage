...
const platformColors: Record<string, string> = {
  ...
  PlayStation:
    "bg-p2-electric-indigo text-pure-white hover:bg-p2-mint-flash hover:text-p2-charcoal",
  Switch:
    "bg-p2-gray-whisper text-p2-charcoal hover:bg-p2-mint-flash hover:text-p2-charcoal",
  iOS: "bg-p2-mint-flash text-p2-charcoal hover:bg-p2-coral-burst hover:text-pure-white",
  Android:
    "bg-p2-coral-burst text-pure-white hover:bg-p2-mint-flash hover:text-p2-charcoal",
};
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-charcoal text-pure-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto relative flex flex-col border border-p2-mint-flash/30"
        ...
        >
          ...
          <div className="p-6 sm:p-8 space-y-5 flex-grow flex flex-col">
            ...
            <div>
              <h4 className="text-lg font-semibold mb-2 text-p2-coral-burst">
                Download Links:
              </h4>
